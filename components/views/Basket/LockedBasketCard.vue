    ...
    <div class="product-content">
      ...
      <div class="product-list-basket">
        <div class="table-container">
          <table class="product-table ">
            <thead>
              <tr class="bug-fix">
                <th style="margin-right: 245px;">Ürün</th>
                <th>Miktar</th>
                <th>Birim Fiyatı</th>
                <th>Satır Toplamı</th>
              </tr>
      ...
      <div class="basket-control">
        <div class="control locked-basket-desc">
          ...
          <p class="locked-text">
            Kilitli sepet, size özel bir teklif veya vereceğiniz özel bir sipariş
            için hazırlanmıştır. İçeriği ve detayları değiştirilemez.
          </p>
        </div>
      </div>
    </div>
...
.bug-fix {
  grid-template-columns: 0.1fr 4fr 1fr 1fr !important;
}
