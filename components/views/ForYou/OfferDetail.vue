<template>
  <div>
    ...
    <div class="p-20" style="overflow-y: auto">
      <h1 class="title">Teklif Detayları&nbsp;</h1>
      <div class="flex row flex-1 mb-15 p-15 border radius-5">
        <div class="flex-1">
          <div class="doc-no">
            <div class="field">
            ...
            <div class="field">
              ...
              <div class="control">
                <input
                  class="input"
                  type="text"
                  :value="detail.doc_date"
                  readonly=""
                />
              </div>
            </div>
          </div>
          <div class="recipient mt-20">
            <div class="field">
      ...
      <table class="table is-fullwidth is-striped is-bordered offer-detail">
        ...
        <tbody>
          <tr v-for="(item, index) in detail.items" :key="item + '-' + index">
            ...
            <td style="white-space: nowrap">
              {{ item.total_price | numberFormatTr }}
              {{ currencySymbol[detail.currency] }}
            </td>
            <td style="white-space: nowrap">
            ...
            <td style="white-space: nowrap">
              {{ item.gross | numberFormatTr }}
              {{ currencySymbol[detail.currency] }}
            </td>
            <td style="white-space: nowrap">
              {{ item.tax_amaount | numberFormatTr }}
              {{ currencySymbol[detail.currency] }}
            </td>
            <td style="white-space: nowrap">
              {{ item.sub_total_price | numberFormatTr }}
              {{ currencySymbol[detail.currency] }}
            </td>
          </tr>
        </tbody>
        <tfoot>
          <tr>
            ...
            <td>
              {{ detail.gross_total | numberFormatTr
              }}{{ currencySymbol[detail.currency] }}
            </td>
          </tr>
          <tr>
            ...
            <td>
              {{ detail.discount_rate | numberFormatTr
              }}{{ currencySymbol[detail.currency] }}
            </td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td>
              {{ detail.total_tax | numberFormatTr
              }}{{ currencySymbol[detail.currency] }}
            </td>
          </tr>
          <tr>
            ...
            <td>
              {{ detail.total_price | numberFormatTr
              }}{{ currencySymbol[detail.currency] }}
            </td>
          </tr>
        </tfoot>
        ...
        <div class="field is-grouped is-grouped-multiline">
          ...
          <div class="control">
            <div class="tags has-addons">
              ...
              >
              <span class="tag"
                >%{{ detail.discount_rate | numberFormatTr }}</span
              >
            </div>
          </div>
        </div>
